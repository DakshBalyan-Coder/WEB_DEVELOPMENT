...
<head>
  ...
  <script src="https://kit.fontawesome.com/729ad3ad9c.js" crossorigin="anonymous"></script>
...
<body>
  ...
  <section id="title">
    ...
    <div class="row">
      ...
      <button type="button" class="btn btn-outline-light btn-lg download-button"><i class="fa-brands fa-google-play" style="color: #fafcff;"></i> Download</button>
  ...
  <section id="features">
    ...
    <div class="feature-box col-lg-4">
      <i class="icon fa-solid fa-circle-check fa-5x"></i>

    <h3 class="feature-title">Easy to use.</h3>
    <p>So easy to use, even your dog could do it.</p>
</div>
<div class="feature-box col-lg-4">
  <i class="icon fa-solid fa-bullseye fa-5x"></i>
